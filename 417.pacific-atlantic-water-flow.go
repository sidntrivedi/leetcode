...
func pacificAtlantic(heights [][]int) [][]int {
	// Start a DFS from left corner and right
	// corner of the 2d heights array.
	// Only go further if the next neightbour's heigh is greater
	// then the curent node.
	// The points where they coincide are the points
	// from where water can flow into both the oceans.
