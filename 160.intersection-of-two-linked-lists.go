...
// Two approaches.
// First is to iterate list A and store all node addresses in a hashtable.
// Then iterate list B and check if any of the node address already exists in the hashtable already.
// If yes, we have an intersection.

// Optimal approach:
// Start walking using a pointer the list A and List B.
// Start walking another pointer list A and list b.
// Both should meet at the same node address or same place.
